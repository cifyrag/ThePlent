...
public interface IAchievementsService
{
    ...
    Task<Result<Achievement>> AddAchievement(Achievement achievementData); 
        ...
        Task<Result<bool>> RemoveAchievement(Guid achievementId); 
        ...
        Task<Result<Achievement>> GetAchievement(Guid achievementId); 
        ...
        Task<Result<System.Collections.Generic.IEnumerable<Achievement>>> GetAchievements(Guid? userId = null);
        ...
        Task<Result<bool>> MarkAsDone(Guid userId, Guid achievementId);
        ...
        Task<Result<Success>> ShareAchievement(Guid userId, Guid achievementId, string platform); 
}